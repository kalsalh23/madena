...
export const demoCategories = [
  { id: 'c-places-schools', name: 'المدارس', slug: 'schools', type: 'places', icon: 'GraduationCap', color: '#084239', sort_order: 1 },
  { id: 'c-places-hospitals', name: 'المشافي', slug: 'hospitals', type: 'places', icon: 'Cross', color: '#5f0113', sort_order: 2 },
  { id: 'c-places-pharmacies', name: 'الصيدليات', slug: 'pharmacies', type: 'places', icon: 'Pill', color: '#084239', sort_order: 3 },
  { id: 'c-places-restaurants', name: 'المطاعم', slug: 'restaurants', type: 'places', icon: 'Utensils', color: '#958162', sort_order: 4 },
  { id: 'c-places-parks', name: 'الحدائق', slug: 'parks', type: 'places', icon: 'Trees', color: '#0d7562', sort_order: 5 },
